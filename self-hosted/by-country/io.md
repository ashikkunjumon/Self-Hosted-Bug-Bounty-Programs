...
|---|---|---|---|---|
| `agora.io` | [policy](https://docs.agora.io/en/realtime-media/interactive-live-streaming/reference/security) | monetary | — | active |
| `apis.io` | [policy](https://apis.io/security/riverlane/riverlane-vulnerability-disclosure/) | monetary | — | active |
...
| `flagon.io` | [policy](https://www.flagon.io/security) | — | yes | active |
...
| `hrpartner.io` | [policy](https://www.hrpartner.io/security.html) | — | — | active |
| `idena.io` | [policy](https://www.idena.io/contribute) | monetary | — | retired |
| `immutablesoft.github.io` | [policy](https://immutablesoft.github.io/ImmutableEcosystem/) | monetary | — | active |
| `infodeck.io` | [policy](https://www.infodeck.io/responsible-disclosure/) | swag | — | retired |
| `infopeak.io` | [policy](https://infopeak.io/en/security-policy) | swag | yes | active |
...
| `leantime.io` | [policy](https://leantime.io/responsible-disclosure-policy/) | — | — | active |
...
| `synthesia.io` | [policy](https://help.synthesia.io/en/articles/7182166-how-can-i-contact-synthesia) | — | — | active |
| `takt.io` | [policy](https://www.takt.io/legal/responsible-disclosure-policy) | — | — | active |
| `thelibrarian.io` | [policy](https://thelibrarian.io/vulnerability-disclosure-policy) | recognition | yes | active |
| `tyle.io` | [policy](https://tyle.io/info/privacy) | — | — | active |
| `unloq.io` | [policy](https://unloq.io/security) | — | — | active |
| `webdisk.io` | [policy](https://webdisk.io/vdp) | recognition | yes | active |
| `whalebone.io` | [policy](https://www.whalebone.io/vulnerability-disclosure-policy) | — | yes | active |
