...
**A list of 7,659 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,635 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,659 |
| **Self-hosted** | 6,635 |
| **Platform-hosted** | 1,024 |
| **Active** | 5,835 |
| **Offering a reward** | 2,169 |
| **Stating safe harbour** | 731 |
| **Countries** | 55 |

*Last Updated: August 24, 2026 at 08:10 UTC*
...
`recognition` — and whether it explicitly states safe harbour. 2,169
programs offer some reward; only 731 state safe harbour outright, which
...
of the 7,659 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,635 of 7,659 programs run their own
...
Only 731 of 7,659 programs state safe harbour explicitly. That is the
