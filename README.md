...
**A list of 7,929 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,888 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,929 |
| **Self-hosted** | 6,888 |
| **Platform-hosted** | 1,041 |
| **Active** | 5,952 |
| **Offering a reward** | 2,287 |
| **Stating safe harbour** | 820 |
| **Countries** | 59 |

*Last Updated: September 21, 2026 at 14:24 UTC*
...
`recognition` — and whether it explicitly states safe harbour. 2,287
programs offer some reward; only 820 state safe harbour outright, which
...
of the 7,929 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,888 of 7,929 programs run their own
...
Only 820 of 7,929 programs state safe harbour explicitly. That is the
