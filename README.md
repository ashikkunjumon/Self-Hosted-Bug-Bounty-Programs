...
**A list of 7,931 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,890 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,931 |
| **Self-hosted** | 6,890 |
| **Platform-hosted** | 1,041 |
| **Active** | 5,954 |
| **Offering a reward** | 2,288 |
| **Stating safe harbour** | 821 |
| **Countries** | 59 |

*Last Updated: September 25, 2026 at 12:51 UTC*
...
`recognition` — and whether it explicitly states safe harbour. 2,288
programs offer some reward; only 821 state safe harbour outright, which
...
of the 7,931 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,890 of 7,931 programs run their own
...
Only 821 of 7,931 programs state safe harbour explicitly. That is the
