...
**A list of 7,683 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,656 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,683 |
| **Self-hosted** | 6,656 |
| **Platform-hosted** | 1,027 |
| **Active** | 5,863 |
| **Offering a reward** | 2,177 |
| **Stating safe harbour** | 743 |
| **Countries** | 55 |

*Last Updated: August 25, 2026 at 08:06 UTC*
...
`recognition` — and whether it explicitly states safe harbour. 2,177
programs offer some reward; only 743 state safe harbour outright, which
...
of the 7,683 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,656 of 7,683 programs run their own
...
Only 743 of 7,683 programs state safe harbour explicitly. That is the
