...
**A list of 7,730 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,698 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,730 |
| **Self-hosted** | 6,698 |
| **Platform-hosted** | 1,032 |
| **Active** | 5,763 |
| **Offering a reward** | 2,194 |
| **Stating safe harbour** | 746 |
| **Countries** | 56 |

*Last Updated: September 01, 2026 at 12:39 UTC*
...
`recognition` — and whether it explicitly states safe harbour. 2,194
programs offer some reward; only 746 state safe harbour outright, which
...
of the 7,730 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,698 of 7,730 programs run their own
...
Only 746 of 7,730 programs state safe harbour explicitly. That is the
