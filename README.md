...
**A list of 7,927 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,886 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,927 |
| **Self-hosted** | 6,886 |
| **Platform-hosted** | 1,041 |
| **Active** | 5,950 |
| **Offering a reward** | 2,286 |
| **Stating safe harbour** | 819 |
| **Countries** | 59 |

*Last Updated: September 19, 2026 at 11:59 UTC*
...
`recognition` — and whether it explicitly states safe harbour. 2,286
programs offer some reward; only 819 state safe harbour outright, which
...
of the 7,927 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,886 of 7,927 programs run their own
...
Only 819 of 7,927 programs state safe harbour explicitly. That is the
