...
**A list of 7,749 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,716 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,749 |
| **Self-hosted** | 6,716 |
| **Platform-hosted** | 1,033 |
| **Active** | 5,781 |
| **Offering a reward** | 2,198 |
| **Stating safe harbour** | 740 |
| **Countries** | 56 |

*Last Updated: September 02, 2026 at 12:12 UTC*
...
`recognition` — and whether it explicitly states safe harbour. 2,198
programs offer some reward; only 740 state safe harbour outright, which
...
of the 7,749 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,716 of 7,749 programs run their own
...
Only 740 of 7,749 programs state safe harbour explicitly. That is the
