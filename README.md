...
**A list of 7,633 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,611 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,633 |
| **Self-hosted** | 6,611 |
| **Platform-hosted** | 1,022 |
| **Active** | 5,819 |
| **Offering a reward** | 2,166 |
| **Stating safe harbour** | 740 |
| **Countries** | 55 |

*Last Updated: August 22, 2026 at 07:53 UTC*
...
`recognition` — and whether it explicitly states safe harbour. 2,166
...
of the 7,633 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,611 of 7,633 programs run their own
...
Only 740 of 7,633 programs state safe harbour explicitly. That is the
