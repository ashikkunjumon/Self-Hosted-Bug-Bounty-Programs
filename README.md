...
**A list of 7,648 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,626 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,648 |
| **Self-hosted** | 6,626 |
| **Platform-hosted** | 1,022 |
| **Active** | 5,827 |
| **Offering a reward** | 2,165 |
| **Stating safe harbour** | 739 |
| **Countries** | 55 |

*Last Updated: August 23, 2026 at 07:55 UTC*
...
`recognition` — and whether it explicitly states safe harbour. 2,165
...
of the 7,648 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,626 of 7,648 programs run their own
...
Only 739 of 7,648 programs state safe harbour explicitly. That is the
