...
**A list of 7,934 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,893 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,934 |
| **Self-hosted** | 6,893 |
| **Platform-hosted** | 1,041 |
| **Active** | 5,957 |
| **Offering a reward** | 2,290 |
...
`recognition` — and whether it explicitly states safe harbour. 2,290
programs offer some reward; only 823 state safe harbour outright, which
...
of the 7,934 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,893 of 7,934 programs run their own
...
Only 823 of 7,934 programs state safe harbour explicitly. That is the
