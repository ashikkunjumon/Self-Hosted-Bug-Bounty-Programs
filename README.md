...
**A list of 7,790 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,755 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,790 |
| **Self-hosted** | 6,755 |
| **Platform-hosted** | 1,035 |
| **Active** | 5,814 |
| **Offering a reward** | 2,215 |
| **Stating safe harbour** | 749 |
| **Countries** | 56 |

*Last Updated: September 10, 2026 at 12:18 UTC*
...
`recognition` — and whether it explicitly states safe harbour. 2,215
programs offer some reward; only 749 state safe harbour outright, which
...
of the 7,790 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,755 of 7,790 programs run their own
...
Only 749 of 7,790 programs state safe harbour explicitly. That is the
