...
**A list of 7,757 bug bounty and vulnerability disclosure programs
...
indexed by country, and rebuilt daily. 6,724 of these are
...
| Metric | Count |
|---|---|
| **Total Programs** | 7,757 |
| **Self-hosted** | 6,724 |
| **Platform-hosted** | 1,033 |
| **Active** | 5,784 |
| **Offering a reward** | 2,195 |
| **Stating safe harbour** | 739 |
| **Countries** | 56 |

*Last Updated: September 03, 2026 at 12:11 UTC*
...
`recognition` — and whether it explicitly states safe harbour. 2,195
programs offer some reward; only 739 state safe harbour outright, which
...
of the 7,757 entries carries a URL, so it loads straight into a
recon pipeline.
...
Most of it is **self-hosted**: 6,724 of 7,757 programs run their own
...
Only 739 of 7,757 programs state safe harbour explicitly. That is the
